...
public class PostgresConnectionIT {
    ...
    public void shouldSupportFallbackToRestartLsn() throws Exception {
        ...
        try (PostgresConnection withIdleTransaction = new PostgresConnection(JdbcConfiguration.adapt(TestHelper.defaultJdbcConfig()),
                PostgresConnection.CONNECTION_GENERAL, PostgresConnection.DEFAULT_DRIVER_CLASS_NAME, PostgresConnection.DEFAULT_PROTOCOL, "");
    ...
    private PostgresConnection buildPG95PGConn(String name) {
        return new PostgresConnection(JdbcConfiguration.adapt(TestHelper.defaultJdbcConfig()), name, PostgresConnection.DEFAULT_DRIVER_CLASS_NAME,
                PostgresConnection.DEFAULT_PROTOCOL, "") {
            @Override
